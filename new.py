...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyAS_SLwMwRbPTSRxnX-r8Ukbo-5cXoGdlw'
  ...
  #                 password="Siva@12102002",
   #                database="dt7"
    #              )
        ...
        engine = create_engine('mysql+mysqlconnector://root:Siva12102002@127.0.0.1:3306/dt7', echo=False)
     ...
     #   port=3306,
      #  user = "root",
       # password = "Siva@12102002",
        #auth_plugin = "mysql_native_password"
        #)
connect_for_question = MySQLdb.connect(
    host='127.0.0.1',
    user='root',
    passwd='Siva12102002',
    db='dt7',
